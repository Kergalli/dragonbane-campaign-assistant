...
export function registerSettings() {
  ...
  game.settings.register(MODULE_ID, SETTINGS.ADD_ACTOR_BUTTONS, {
    name: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.addActorButtons.name'),
    hint: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.addActorButtons.hint'),
    scope: 'world',
    config: true,
    type: Boolean,
    default: true,
  ...
  game.settings.register(MODULE_ID, SETTINGS.TRACK_SESSION_HISTORY, {
    name: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.trackSessionHistory.name'),
    hint: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.trackSessionHistory.hint'),
    scope: 'world',
    config: true,
    type: Boolean,
    default: true
  ...
  game.settings.register(MODULE_ID, SETTINGS.USE_WEAKNESS_RULE, {
    name: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.useWeaknessRule.name'),
    hint: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.useWeaknessRule.hint'),
    scope: 'world',
    config: true,
    type: Boolean,
    default: false
  ...
  game.settings.register(MODULE_ID, SETTINGS.HIDE_PARTICIPATED, {
    name: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.hideParticipated.name'),
    hint: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.hideParticipated.hint'),
    scope: 'world',
    config: true,
    type: Boolean,
    default: false
  ...
  game.settings.register(MODULE_ID, SETTINGS.CUSTOM_QUESTIONS, {
    name: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.customQuestions.name'),
    hint: game.i18n.localize('CAMPAIGN_ASSISTANT.settings.customQuestions.hint'),
    scope: 'world',
    config: true,
    type: String,
    default: ''
